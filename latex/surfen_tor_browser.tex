...
Empfehlenswert ist die Installation von AdBlock Plus. Nach der Installation kann man die Sperrliste \textit{EasyList Germany + EasyList} abonnieren sowie die \textit{EasyPrivacy} und \textit{SocialMediaBlock} hinzufügen, wie es im Kapitel \textit{Spurenarm Surfen} beschrieben wurde.
